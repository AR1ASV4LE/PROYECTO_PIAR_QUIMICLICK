...
<div class="titulo-final">
    <h1>¡Confiada por docentes, utilizada por estudiantes!</h1>
    <p>QuimiClick funciona para estudiantes interesados en aprender conceptos de química más rápidamente.</p>
        ...
        if (!$usuarioActivo): ?>
            ...
            <script>
                Swal.fire({
                    ...
                    cancelButtonColor: ' #2497c3 ' // Cancel button color
                }).then((result) => {
