...
if (isset($_GET['success_edit'])) {
    echo "<script>alert('Novedad editada exitosamente.');</script>";
}
?>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($novedad = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
    <form action="./SectionEditarNovedad.php" method="GET" style="display:inline;">
        <input type="hidden" name="id" value="<?php echo $novedad['id']; ?>">
        <button type="submit" style="border: none; background: none; cursor: pointer;">
            <ion-icon name="create-outline" style="color: #ac3846; font-size: 20px;"></ion-icon>
        </button>
    </form>
