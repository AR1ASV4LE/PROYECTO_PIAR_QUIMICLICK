...
<body>
<style>
    /* Contenedor general para el icono en la esquina superior derecha */
    .logout-wrapper {
        position: fixed;
        top: 80px; /* Ajusta el espacio superior */
        right: 150px; /* Ajusta el espacio a la derecha */
        z-index: 10; /* Asegura que esté al frente de otros elementos */
    }
    ...
    .logout-icon {
        font-size: 34px;
        cursor: pointer;
        color: #b33a3a; /* Ajusta el color del icono según tus preferencias */
    }
    ...
    /* Mostrar el mensaje al pasar el cursor sobre el icono */
    .logout-container:hover .logout-tooltip {
        visibility: visible;
        opacity: 1;
    }
</style>
